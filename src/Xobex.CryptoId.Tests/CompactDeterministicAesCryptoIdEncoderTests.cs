...
/// </summary>
[TestClass]
public class CompactDeterministicAesCryptoIdEncoderTests : CryptoIdTestBase
{
    [TestMethod]
    ...
    {
        // Arrange & Act
        using var encoder = new CompactDeterministicAesCryptoIdEncoder(TestKey, TestSalt);
    ...
    public void Constructor_WithNullKey_ThrowsArgumentException()
    {
        ...
        var ex = ThrowsException<ArgumentException>(() =>
            new CompactDeterministicAesCryptoIdEncoder(null!, TestSalt)
        );
    ...
    public void Constructor_WithEmptyKey_ThrowsArgumentException()
    {
        // Arrange & Act & Assert
        var ex = ThrowsException<ArgumentException>(() =>
            new CompactDeterministicAesCryptoIdEncoder("", TestSalt)
        );
        Assert.IsTrue(ex.Message.Contains("null", StringComparison.OrdinalIgnoreCase) ||
                     ex.Message.Contains("empty", StringComparison.OrdinalIgnoreCase));
    }
    ...
    public void Constructor_WithNullSalt_ThrowsArgumentNullException()
    {
        ...
        ThrowsException<ArgumentNullException>(() =>
            new CompactDeterministicAesCryptoIdEncoder(TestKey, null!)
        );
    }
...
#pragma warning restore MSTEST0052 // Avoid passing an explicit 'DynamicDataSourceType' and use the default auto detect behavior
    ...
    {
        // Arrange
        using var encoder1 = new CompactDeterministicAesCryptoIdEncoder("key-1", TestSalt);
        using var encoder2 = new CompactDeterministicAesCryptoIdEncoder("key-2", TestSalt);
    ...
    public void Encode_DifferentSalts_ProduceDifferentCiphertexts()
    {
        ...
        using var encoder1 = new CompactDeterministicAesCryptoIdEncoder(TestKey, TestSalt);
        using var encoder2 = new CompactDeterministicAesCryptoIdEncoder(TestKey, salt2);
        var testValue = 123456L;
    ...
    {
        // Arrange
        var encoder = new CompactDeterministicAesCryptoIdEncoder(TestKey, TestSalt);
