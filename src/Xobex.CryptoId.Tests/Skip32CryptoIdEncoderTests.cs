// <copyright file="Skip32CryptoIdEncoderTests.cs" company="Dmitry Kolchev">
...
/// <summary>
/// Tests for Skip32CryptoIdEncoder using Skip32 encryption for int IDs.
/// </summary>
[TestClass]
public class Skip32CryptoIdEncoderTests : CryptoIdTestBase
{
    [TestMethod]
    ...
    {
        // Arrange & Act
        var encoder = new Skip32CryptoIdEncoder(TestKey, TestSalt);
    ...
    public void Constructor_WithNullKey_ThrowsArgumentException()
    {
        ...
        var ex = ThrowsException<ArgumentException>(() =>
            new Skip32CryptoIdEncoder(null!, TestSalt)
        );
    ...
    public void Constructor_WithEmptyKey_ThrowsArgumentException()
    {
        // Arrange & Act & Assert
        var ex = ThrowsException<ArgumentException>(() =>
            new Skip32CryptoIdEncoder("", TestSalt)
        );
        Assert.IsTrue(ex.Message.Contains("null", StringComparison.OrdinalIgnoreCase) ||
                     ex.Message.Contains("empty", StringComparison.OrdinalIgnoreCase));
    }
    ...
    public void Constructor_WithNullSalt_ThrowsArgumentNullException()
    {
        ...
        ThrowsException<ArgumentNullException>(() =>
            new Skip32CryptoIdEncoder(TestKey, null!)
        );
    }
    ...
    {
        // Arrange
        var encoder1 = new Skip32CryptoIdEncoder("key-1", TestSalt);
        var encoder2 = new Skip32CryptoIdEncoder("key-2", TestSalt);
    ...
    public void Encode_DifferentSalts_ProduceDifferentCiphertexts()
    {
        ...
        var encoder1 = new Skip32CryptoIdEncoder(TestKey, TestSalt);
        var encoder2 = new Skip32CryptoIdEncoder(TestKey, salt2);
        var testValue = 123456;
