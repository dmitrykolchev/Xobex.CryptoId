...
public class AesCryptoIdEncoderTests : CryptoIdTestBase
{
    ...
    {
        // Arrange & Act
        using var encoder = new AesCryptoIdEncoder(TestKey, TestSalt);
    ...
    public void Constructor_WithNullKey_ThrowsArgumentException()
    {
        ...
        var ex = ThrowsException<ArgumentException>(() =>
            new AesCryptoIdEncoder(null!, TestSalt)
        );
    ...
    public void Constructor_WithEmptyKey_ThrowsArgumentException()
    {
        // Arrange & Act & Assert
        var ex = ThrowsException<ArgumentException>(() =>
            new AesCryptoIdEncoder("", TestSalt)
        );
        Assert.IsTrue(ex.Message.Contains("null", StringComparison.OrdinalIgnoreCase) ||
                     ex.Message.Contains("empty", StringComparison.OrdinalIgnoreCase));
    }
    ...
    public void Constructor_WithNullSalt_ThrowsArgumentNullException()
    {
        ...
        ThrowsException<ArgumentNullException>(() =>
            new AesCryptoIdEncoder(TestKey, null!)
        );
    }
    ...
    {
        // Arrange
        using var encoder1 = new AesCryptoIdEncoder("key-1", TestSalt);
        using var encoder2 = new AesCryptoIdEncoder("key-2", TestSalt);
    ...
    public void Encode_DifferentSalts_ProduceDifferentCiphertexts()
    {
        ...
        using var encoder1 = new AesCryptoIdEncoder(TestKey, TestSalt);
        using var encoder2 = new AesCryptoIdEncoder(TestKey, salt2);
        var testValue = 123456L;
    ...
    {
        // Arrange
        var encoder = new AesCryptoIdEncoder(TestKey, TestSalt);
